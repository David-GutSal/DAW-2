...
public class TripulacionController {
	...
	public String listadoTripulaciones(@RequestParam(value = "nombre", required = false) String nombre,
		...
		ArrayList<TripulacionDTO> listaTripulaciones = tripulacionService.obtenerTripulacionesPorFiltro("", nombre,
				barco, act);
	...
	public String formularioDetallesTripulaciones(@RequestParam("id") String id, ModelMap model) {
	...
	public String formularioAgregarNuevoMiembro(@RequestParam("idPirata") String idPirata,
			@RequestParam("idTripulacion") String idTripulacion, @RequestParam("rol") String rol, ModelMap model) {
	...
	public String formularioEliminarNuevoMiembro(@RequestParam("idPirata") Integer idPirata,
	...
	public String insertarTripulacionPost(@RequestParam String nombre, @RequestParam String barco,
			@RequestParam(required = false) Integer estaActiva,  ModelMap model) {
		boolean activa = (estaActiva != null);
		Integer resultado = tripulacionService.insertarTripulacion(nombre, barco, activa);
		model.addAttribute("resultado", resultado);
		return "tripulaciones/insertarTripulacion";
	}
	...
	public String buscarTripulacionesActualizar(@RequestParam(required = false) String id,
			@RequestParam(required = false) String nombre, @RequestParam(required = false) Integer estaActiva,
			ModelMap model) {
		Boolean activa = (estaActiva != null);
		model.addAttribute("lista", tripulacionService.obtenerTripulacionesPorFiltro(id, nombre, "", activa));
		return "tripulaciones/actualizarTripulaciones";
	}

	@PostMapping("/actualizarTripulacion")
	public String actualizarTripulacion(@RequestParam String id, @RequestParam String nombre,
			@RequestParam String barco, @RequestParam(required = false) Integer estaActiva) {
		boolean activa = (estaActiva != null);
		tripulacionService.actualizarTripulacion(id, nombre, barco, activa);
		return "tripulaciones/actualizarTripulaciones";
	}

	@GetMapping("/formularioBorrarTripulaciones")
	public String formularioBorrarTripulaciones(ModelMap model) {
		model.addAttribute("lista", tripulacionService.obtenerTripulacionesPorFiltro("", "", "", true));
		return "tripulaciones/borrarTripulaciones";
	}

	@PostMapping("/formularioBorrarTripulaciones")
	public String buscarTripulacionesParaBorrar(@RequestParam(required = false) String id,
			@RequestParam(required = false) String nombre, ModelMap model) {
		model.addAttribute("lista", tripulacionService.obtenerTripulacionesPorFiltro(id, nombre, "", true));
		return "tripulaciones/borrarTripulaciones";
	}

	@PostMapping("/borrarTripulacion")
	public String borrarTripulacion(@RequestParam Integer id, ModelMap model) {

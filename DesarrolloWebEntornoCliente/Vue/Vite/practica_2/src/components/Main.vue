        ...
        <section id="formularios">
            ...
            <form id="nuevaPregunta">
                <fieldset>
                    ...
                    <select id="tema" class="nuevaPreg" v-model="nuevaPregunta.temaPregunta">
                        <option :value="index" v-for="(tema, index) in temasDisponibles" :key="index">{{ tema.nombre }}
                        </option>
                    </select>
                    <br>
                    ...
                    <input type="text" id="op1" class="nuevaPreg" v-model="nuevaPregunta.campo1" required>
                    <br>
                    <label for="op2" class="nuevaPregLabel">Opción 2</label>
                    <input type="text" id="op2" class="nuevaPreg" v-model="nuevaPregunta.campo2" required>
                    <br>
                    <label for="op3" class="nuevaPregLabel">Opción 3</label>
                    <input type="text" id="op3" class="nuevaPreg" v-model="nuevaPregunta.campo3" required>
                    <br>
                    <label for="op4" class="nuevaPregLabel">Opción 4</label>
                    <input type="text" id="op4" class="nuevaPreg" v-model="nuevaPregunta.campo4" required>
                    <br>
                    <label for="respCorrecta">Respuesta correcta</label>
                    <input type="number" id="respCorrecta" min="1" max="4" v-model="nuevaPregunta.respuesta" required>
